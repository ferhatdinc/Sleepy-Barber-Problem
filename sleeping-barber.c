...
Müşteri dükkana gelir ve mutex kilidi ile critical section ı kilitler.
boş sandalye sayısı kontrol edlir.
eğer boş sandalye varsa salonda bekler. ve sandalye sayısını azaltır.
Boş bir berber koltuğu bulduğunda ise bekleme salonu mutexini kaldırır ve berber 
koltuğu kildini aktifleştirir.
işi bittiğinde ise kilidi diğer müşteriler için açar.

En başta eğer boş sandalye bulamasaydı salondan mutex kilidini açıp ayrılcaktı.

Berber
Berber dükkana gelir ve müşteri sayısına bakar. Eğer müşteri yoksa uyuyan berber
kyruğuna katılır. 

Daha sonra müşteri varsa Bekleyenler arasından bir tane müşteri seçer ve
müşteriyi tıraş edene kadar koltuğu kilitler. açıp müşteri ile ilgilenmeye başlar.
